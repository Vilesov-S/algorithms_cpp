...
public:
    ...
    void push_front(int new_item)
    {
        ...
        {
            tmp->pNext = pFirstItem;                                  // адресс первого элемента становится следующим для текущего
            tmp->pPrevious = pLastItem;                               // адресс последнего элемента становится предыдущим для текущего
